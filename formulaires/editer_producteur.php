...
function formulaires_editer_producteur_charger_dist(){
	...
	(_request('type_evelvage')?$valeurs['type_evelvage'] = _request('type_evelvage'):$valeurs['type_evelvage'] =$valeurs['type_evelvage']);
...
function formulaires_editer_producteur_traiter_dist(){
	...
	$valeurs['type_evelvage'] = _request('type_evelvage');
